---
name: "source-command-contexto"
description: "Ponte al día con el estado del proyecto antes de empezar a trabajar"
---

# source-command-contexto

Use this skill when the user asks to run the migrated source command `contexto`.

## Command Template

Ponte al día con el proyecto antes de tocar código:

1. Lee `AGENTS.md` (arquitectura, decisiones que no se rompen, estado actual).
